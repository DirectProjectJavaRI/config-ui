...
<html>
    <head>
		...
		$('#assignBundles').load('bundles/assignBundlesForm');
                ...
                $('[name="incoming"]').change( function() {
                    ...
                    $.post('/domain/updateBundleDirection',data, function(data) {
                ...
                $('[name="outgoing"]').change( function() {
                    ...
                    $.post('/domain/updateBundleDirection',data, function(data) {
                        window.location.href = "/domain?id=${domainName}#tab3";
                    });
                });
 ...
 function removeBundles() {
    ...
    <body>
        ...
        <spring:url value="/domain/saveupdate" var="formUrl" />
        <form:form
        ...
        <c:otherwise>
            ...
            <div class="container">
                ...
                <div style="">
                    ...
                    <spring:url
                            value="/domain/removeaddresses" var="formUrlremove" /> <form:form
            ...
            <div id="tab2" class="tab_content">
                <c:choose>
                    ...
                    <c:otherwise>
                            ...
                            <spring:url value="/domain/addanchor" var="formUrladdanchor" /> 
