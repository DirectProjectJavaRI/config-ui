...
<spring:url value="/domain/saveupdate" var="formUrl" /> <form:form
	id="domainForm" action="${fn:escapeXml(formUrl)}" cssClass="cleanform"
	modelAttribute="domainForm" method="POST">
		...
		<div id="tabs-1">
		  <fieldset style="width: 90%;" title="AddressesGroup"><legend>Addresses</legend>
		      <fieldset style="width: 90%;" title="Address"><spring:url
			     value="/domain/addaddress" var="formUrladdaddress" /> <form:form
...
<c:if test="${not empty addressesResults}">
    <spring:url value="/domain/removeaddresses" var="formUrlremove" />
    <form:form
...
<c:if test='${not empty action && action != "Add" }'>
		...
		<fieldset style="width: 95%;" title="anchor"><spring:url
			value="/domain/addanchor" var="formUrladdanchor" /> <form:form
...
<c:if test="${not empty anchorsResults}">
	...
	<spring:url value="/domain/removeanchors" var="formUrlremoveanchor" />
	<form:form
		modelAttribute="anchorForm"
...
<c:if test='${not empty action && action != "Add" }'>
        ...
        <spring:url value="/domain/addDNSEntry" var="formUrladdDNSEntry" />
...
<c:if test="${not empty dnsResults}">
    <fieldset style="width: 95%;" title="dnsEntries">
	    <spring:url value="/domain/removeDnsEntries" var="formUrlremoveDns" />
	    <form:form
