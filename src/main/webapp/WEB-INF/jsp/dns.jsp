...
<spring:url
	value="/dns/addADNSRecord" var="formUrladdARecord" /> <form:form
...
<c:if test="${not empty dnsARecordResults}">
	...
	<div id="aList" style="width: 100%; overflow: auto;"><spring:url
		value="/dns/removesettings" var="formUrlRemoveDns" /> <form:form
...
<spring:url
	value="/dns/addA4DNSRecord" var="formUrladdARecord" /> <form:form
...
<spring:url
	value="/dns/addCNAMEDNSRecord" var="formUrladdCnameRecord" /> <form:form
...
<spring:url
	value="/dns/addMXDNSRecord" var="formUrladdMXRecord" /> <form:form
...
<spring:url
	value="/dns/addSRVDNSRecord" var="formUrladdSrvRecord" /> <form:form
...
<spring:url
	value="/dns/addSOADNSRecord" var="formUrladdSoaRecord" /> <form:form
...
<spring:url
	value="/dns/addNSDNSRecord" var="formUrladdNSRecord" /> <form:form
