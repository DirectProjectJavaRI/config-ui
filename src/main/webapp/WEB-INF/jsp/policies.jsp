            ...
            <div class="container">
                <div class="tab_container">
                    ...
                    <div id="tab1" class="tab_content">
                        ...
                        <a href="/policies/newPolicyForm" class="revealLink" data-reveal-ajax="true">Add New Policy</a>

                           <c:choose>
                            <c:when test="${not empty policies}">
	
                                <spring:url value="/policies/removePolicies" var="formURLRemovePolicies" />                                
                                            ...
                                            <tbody>
                                                    ...
                                                    <c:forEach var="policy" items="${policies}" varStatus="rowCounter">
                                                        <c:choose>
                                                            ...
                                                            <td><a href="/policies/updatePolicyForm?id=<c:out value="${policy.id}"/>" class="revealLink" data-reveal-ajax="true"><c:out value="${policy.policyName}"/></a></td>
