            ...
            <form:form id="loginForm" action="login" method="POST">
                ...
                <table border="0" align="center">
                    <tr>
                        ...
                        <td width=200><input type="text" name="username" style="width:200px"/></td>
                    </tr>
                    <tr>
                        <td width=75>Password: </td>
                        <td width=200 align=left><input type="password" name="password" style="height: 20px; width: 205px"/></td>
                    </tr>
                    <tr>
